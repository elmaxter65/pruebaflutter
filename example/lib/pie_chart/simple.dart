...
class SimplePieChart extends StatelessWidget {
  ...
  factory SimplePieChart.withRandomData(json) {
    return new SimplePieChart(_createRandomData(json));
  }
  ...
  static List<charts.Series<LinearSales, int>> _createSampleData(json) {
    List fjson=jsonDecode(json);
    var data;
    for(int i=0;i<fjson.length;i++)
    {
      data = new LinearSales(fjson[i]["no_usuario"], fjson[i]["ReceitaLíquida"]);
    }
